...
BANK_WIRE_PATTERNS = [
    re.compile(r"\brouting\b", re.I),
    re.compile(r"\bwire\b", re.I),
    re.compile(r"\baccount\s*(?:number|#|no\.?)?\s*[:#]?\s*\d{6,}", re.I),
...
CREDENTIAL_PATTERNS = [
    ...
    re.compile(r"StagingPass!\S*", re.I),
    re.compile(r"here is the staging api key", re.I),
]

EXFIL_PATTERNS = [
    re.compile(r"customer[_\s-]?list", re.I),
    re.compile(r"full customer", re.I),
    re.compile(r"internal[_ ]?sop", re.I),
    re.compile(r"partner_pricing_internal", re.I),
    re.compile(r"sop_pack", re.I),
    re.compile(r"CUST-\d{4}"),
]

ATTACHMENT_SOP_PATTERNS = [
    re.compile(r"\.pdf\b", re.I),
    re.compile(r"\.xlsx?\b", re.I),
    re.compile(r"\.csv\b", re.I),
    re.compile(r"internal_sop", re.I),
    re.compile(r"customer_list", re.I),
    re.compile(r"partner_pricing", re.I),
]
